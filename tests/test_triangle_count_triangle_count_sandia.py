...
from project.triangle_count import triangle_count_sandia
import numpy as np
...
def test_triangle_count_dot1():
    assert triangle_count_sandia(digraph_to_matrix_gb(read_dot_file(path_dot1))) == 5


def test_triangle_count_dot2():
    assert triangle_count_sandia(digraph_to_matrix_gb(read_dot_file(path_dot2))) == 1
